...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <h2 class="mb-3">Добавить стих</h2>

        <div class="row">
            <div class="col-12">
                <form action="{{ route('admin.poesy.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group w-50">
                        <h4>Лид стиха</h4>
                        <textarea id="summernote1" rows="3" name="lead"></textarea>
                        @error('lead')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
